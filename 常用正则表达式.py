...
# 130503 67 0401 001
# 身份证号码(18位)
# "[1-9]\d{5}(?:19|20)\d\d(?:0[1-9]|1[012])(?:0[1-9]|[12]\d|3[01])\d{3}(?:[Xx]|\d)"
# 身份证号码(15位)
# "[1-9]\d{7}(?:0[1-9]|1[012])(?:0[1-9]|[12]\d|3[01])\d{3}"
# 身份证号
# "[1-9]\d{5}(?:19|20)\d\d(?:0[1-9]|1[012])(?:0[1-9]|[12]\d|3[01])\d{3}(?:[Xx]|\d)|[1-9]\d{7}(?:0[1-9]|1[012])(?:0[1-9]|[12]\d|3[01])\d{3}"
# 身份证号(18位未区分世纪)
# "[1-9]\d{5}(?:\d{2}|\d{4})(?:0[1-9]|1[012])(?:0[1-9]|[12]\d|3[01])(?:\d{4}|\d{3}[Xx]|\d{3})"
...
if __name__ == '__main__':
    ...
    # pattern = "[1-9]\d{5}(?:\d{2}|\d{4})(?:0[1-9]|1[012])(?:0[1-9]|[12]\d|3[01])(?:\d{4}|\d{3}[Xx]|\d{3})"
